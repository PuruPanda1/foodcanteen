        ...
        <div class="container">
            ...
            <div class="food-menu-box">
                <div class="food-menu-img">
                    <img src="images/menu-pizza.jpg" alt="Cheese burst pizza" class="img-responsive img-curve"></a>
                </div>
                <div class="food-menu-desc">
                    <h4>Cheese burst pizza</h4>
                    <p class="food-prize">Rs. 250</p>
            ...
            <div class="food-menu-box">
                <div class="food-menu-img">
                    <img src="images/momo.jpg" alt="Fried Momo" class="img-responsive img-curve"></a>
                </div>
                <div class="food-menu-desc">
                    <h4>Fried Momo</h4>
            ...
            <div class="food-menu-box">
                <div class="food-menu-img">
                    <img src="images/coke.jpg" alt="Coca coka" class="img-responsive img-curve"></a>
                </div>
                <div class="food-menu-desc">
                    <h4>Coca coka</h4>
                    <p class="food-prize">Rs. 30</p>
                    <p class="food-detail">Soft Drink</p>
            ...
            <div class="food-menu-box">
                <div class="food-menu-img">
                    <img src="images/comboff.jpg" alt="Combo" class="img-responsive img-curve"></a>
                </div>
                <div class="food-menu-desc">
                    <h4>Combo Pack</h4>
                    <p class="food-prize">Rs. 350</p>
                    <p class="food-detail">2 Buger + 2 Coke + 2 French Fries</p>
